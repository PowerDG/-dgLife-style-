...
To show that two people, represented by a single grammatical subject, are acting on each other, one uses the reciprocal pronouns: "**each other**" or "**one another**".
